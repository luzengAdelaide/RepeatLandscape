...
=head1 SYNOPSIS
  ...
  createRepeatLandscape.pl [-version] -div *.divsum -g # | -twoBit <twoBitFile>
...
=head1 EXAMPLES
  ...
  Older ( pre 4.0.4 ) RepeatMasker dataset:
     ...
     ./createRepeatLandscape.pl -div example.divsum > 
                                /home/user/public_html/example.tsv 
...
print join("\t", "divergence", @landscapeGraphLabels, "total");
print "\n";
